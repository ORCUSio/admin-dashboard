  ...
  return (
    <section className="flex flex-col w-[100%] gap-10 overflow-x-hidden  mb-1">
      <section className="self-center flex flex-col gap-5">
        <section class="flex flex-col w-[700px] gap-4 px-6 py-5 mt-8 rounded bg-[#F8FAFC]">
          <div class="flex flex-col gap-2">
            <h2 class="font-bold text-sm">Amount</h2>
            <input
              type="text"
              placeholder="$0.00"
              class="border-2 rounded-md px-2 text-lg"
            ></input>
          </div>
          <div class="flex flex-col gap-2">
                ...
                <div class="w-8 h-8 rounded-sm bg-[#FDF2F8] flex justify-center items-center">
                  ...
                  >
                    <g id="Group">
                      <path
                        id="Vector"
                        d="M10.9497 1.05029L1.05021 10.9498"
                        stroke="#ED4F9D"
                        stroke-width="1.5"
                        stroke-linecap="round"
                        stroke-linejoin="round"
